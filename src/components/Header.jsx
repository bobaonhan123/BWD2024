    ...
    return (
        ...
        max-w-7xl' >
                ...
                <div
                    ...
                    absolute right-4
                    text-[#6C7580]"
                    onClick={handleMenu}><FontAwesomeIcon icon={faBars} /></div>
                ...
                max-lg:duration-500
                max-lg:ease-in-out
                    ${showMenu ? 'max-lg:transform translate-x-0' : 'max-lg:transform max-lg:translate-x-full'}
                `}
                >
                    <div className="absolute top-6 right-6 text-3xl text-[#6C7580] hidden
                    max-lg:block"
                        onClick={handleMenu}><FontAwesomeIcon icon={faXmark} /></div>
                    <a href='#' className='ml-8 text-base text-[#6C7580] max-lg:text-lg max-lg:ml-2 max-lg:my-2' >
                        Pricing
                    </a>
                    <Link to='about' className='ml-8 text-base text-[#6C7580] max-lg:text-lg max-lg:ml-2 max-lg:my-2' >
                        About us
                    </Link>
