...
import { getGlobalFlashcardSet, getUserFlashcardSet } from "../api/flashcardAPI";
...
export default function ListFlashcards() {
  ...
  // Filter flashcards based on searchText
      ...
      <div className="flex justify-center mt-4">
        ...
        {adjustedStartPage > 1 && (
          <>
            ...
            {adjustedStartPage > 2 && (
              <span className="px-4 py-2 mx-1 rounded-lg text-sm ">
                ...
              </span>
            )}
          </>
