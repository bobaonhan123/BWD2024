    ...
    return (
        <div className="w-full pt-8">
            <div className="h-11 mx-12 bg-white rounded-full flex justify-start items-center text-[#6C7580] px-10">
                ...
                <input type="text" className="w-full h-full bg-transparent outline-none px-4" 
            ...
            px-12">
                ...
                flex justify-start w-2/3">
                    ...
                    flex items-center
                    mr-2
                    ${category === "my-cards" ? "bg-[#E8F2FF] text-[#35509A]" : ""}
                    `}
                    ...
                    <div
                        ...
                        flex items-center
                        mr-2
                        ${category === "studying" ? "bg-[#E8F2FF] text-[#35509A]" : ""}
                    `}
                        onClick={handleCategoryClick}
                    >Studying</div>
                    <div
                        ...
                        flex items-center
                        mr-2
                        ${category === "explore" ? "bg-[#E8F2FF] text-[#35509A]" : ""}
                    `}
                        onClick={handleCategoryClick}
                    >explore</div>
                </div>
                ...
                font-semibold
                cursor-pointer
                ">Create cards <span className="text-2xl font-extralight
                mx-1">+</span></button>
            </div>
            <div className="
            grid
