...
import { faFolderOpen, faFlag, faPen, faArrowUpFromBracket, faEllipsisVertical } from "@fortawesome/free-solid-svg-icons";
...
export default function CardDetails() {
    ...
    return (
        ...
        min-h-screen">
            ...
            font-semibold
            text-2xl">{FakeCardsSetElement.title}</h1>
            <div className="flex items-center mt-4
            text-[#6C7580]">
                <div className="flex items-center ">
                    <img src={FakeCardsSetElement.avatar} alt="avatar" className="w-8 h-8 rounded-full" />
            ...
            <div className="mt-8 flex items-center justify-between">
                <div className="flex">
                    <div className="bg-transparent text-[#6C7580]
                    ...
                    text-xs h-9 ml-2
                    cursor-pointer">
                        <FontAwesomeIcon icon={faPenToSquare} className="mr-1 text-[#4FACFE]" />
                        Practice
                    </div>
                </div>
            ...
            mx-auto
            border-[#00000013] border-[1.5px]
            cursor-pointer">Add or remove items</div>
        </div>
    )
}